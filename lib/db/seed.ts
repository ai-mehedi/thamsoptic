...
async function seed() {
  ...
  const londonPostcodes: { prefix: string; name: string }[] = [
    ...
    { prefix: 'E10', name: 'Leyton' }, { prefix: 'E11', name: 'Leytonstone' }, { prefix: 'E12', name: 'Manor Park' },
    { prefix: 'E13', name: 'Plaistow' }, { prefix: 'E14', name: 'Poplar' }, { prefix: 'E15', name: 'Stratford' },
    { prefix: 'E16', name: 'Victoria Docks' }, { prefix: 'E17', name: 'Walthamstow' }, { prefix: 'E18', name: 'South Woodford' },
